...
class CourseService:
    ...
    def get_modules_by_course(self, course_id):
        try:
            ...
            print(f"Database Exception inside get_modules_by_course: {str(e)}")
            return []


    # Look for your get_lessons_by_module function and patch it like this:
    def get_lessons_by_module(self, module_id):
        try:
            ...
            print(f"Database Exception inside get_lessons_by_module: {str(e)}")
            return []
