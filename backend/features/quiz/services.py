...
SUPABASE_URL = os.environ.get("SUPABASE_URL") or "https://vjvsxisuvcwricmqnmoo.supabase.co"
SUPABASE_KEY = os.environ.get("SUPABASE_KEY") or "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZqdnN4aXN1dmN3cmljbXFubW9vIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDMwMzU0MTYsImV4cCI6MjA1ODYxMTQxNn0.dMCdSmV4Cm"
...
class QuizService:
    ...
    def create_question(quiz_id, data):
        ...
        try:
            ...
            # Fallback handling from original code
