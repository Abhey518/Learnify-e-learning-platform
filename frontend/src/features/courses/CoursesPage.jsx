...
export default function CoursesPage() {
  ...
  // NEW: Auth and Enrollment States
  ...
  useEffect(() => {
    // 1. Fetch current user to check if logged in
  ...
  const handleEnrollClick = (courseId) => {
    ...
    fetch(`${baseUrl}/enrollment/enroll`, {
      ...
      .then(() => {
        // Enrollment success! Add to our local visual state
                      ...
                      <div className="card-body d-flex flex-column justify-content-between p-3.5">
                        ...
                        <div className="d-flex align-items-center justify-content-between pt-2 border-top mt-auto">
                          ...
                          {isEnrolled ? (
                            ...
                            <div className="spinner-border spinner-border-sm text-primary" role="status" style={{ color: '#6f42c1' }}>
                              <span className="visually-hidden">Enrolling...</span>
                            </div>
                          ) : (
                            <button 
                              className="btn btn-sm text-white px-3 fw-medium rounded-pill" 
